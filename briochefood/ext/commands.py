...
def populate_db():
    ...
    data = [
        ...
        User(id=2, name='Amelia', lastname='Brand', email='ameliabrand@gmail.com', password="12345",
             phone='5538998411815', status='ACTIVE', created_at=datetime.now(), updated_at=None),
        User_Address(user_id=2, address_id=2),
        User(id=3, name='Joseph', lastname='Cooper', email='josephcooper@gmail.com', password="12345",
             phone='5538998411815', status='ACTIVE', created_at=datetime.now(), updated_at=None),
